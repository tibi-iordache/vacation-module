...
export const createEntity = createAsyncThunk(
  'nationalDay/create_entity',
  async (entity: INationalDay, thunkAPI) => {
    const result = await axios.post<INationalDay>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  'nationalDay/update_entity',
  async (entity: INationalDay, thunkAPI) => {
    const result = await axios.put<INationalDay>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  'nationalDay/partial_update_entity',
  async (entity: INationalDay, thunkAPI) => {
    const result = await axios.patch<INationalDay>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const deleteEntity = createAsyncThunk(
  'nationalDay/delete_entity',
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<INationalDay>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
