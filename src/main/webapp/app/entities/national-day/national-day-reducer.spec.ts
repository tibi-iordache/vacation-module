...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NATIONALDAY_LIST actions', async () => {
    ...
    it('dispatches FETCH_NATIONALDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NATIONALDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NATIONALDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NATIONALDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NATIONALDAY actions', async () => {
      const expectedActions = [
        {
